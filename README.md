...
<img src="./resources/screenshot.png" alt="Скриншот интерфейса" />
...
### 🔐 Сервер не запускается: нет прав на выполнение (Permission denied)

Если при запуске сервера на macOS или Linux возникает ошибка `permission denied` или файл просто не запускается, скорее всего, у него нет прав на выполнение.
...
🪟 **Windows**
    ...
    Запустите исполняемый файла от имени администратора
